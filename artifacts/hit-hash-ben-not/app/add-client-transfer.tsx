...
export default function AddClientTransferScreen() {
  ...
  if (saved) {
    const goBack = () => { if (router.canGoBack()) { router.back(); } else { router.replace("/(tabs)/client-transfers"); } };
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <View style={styles.successBody}>
          ...
          <Text style={[styles.successSub, { color: colors.mutedForeground }]}>Your client transfer has been saved.</Text>
