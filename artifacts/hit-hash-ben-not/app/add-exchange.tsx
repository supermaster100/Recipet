    ...
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <View style={styles.successBody}>
          ...
          <Text style={[styles.successTitle, { color: colors.foreground }]}>Exchange Saved</Text>
          <Text style={[styles.successSub, { color: colors.mutedForeground }]}>Your exchange record has been saved.</Text>
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { paddingTop: topInset + 8, borderBottomColor: colors.border }]}>
        ...
        <TouchableOpacity onPress={handleSave} disabled={!canSave} hitSlop={8} style={styles.saveBtnWrap}>
          {saving ? (
            <ActivityIndicator color={canSave ? colors.primary : colors.mutedForeground} size="small" />
          ) : (
